...
import { initializeBackgroundJobs } from "~/server/services/background-jobs";

// Initialize background jobs once when the server starts
let backgroundJobsInitialized = false;
if (!backgroundJobsInitialized) {
